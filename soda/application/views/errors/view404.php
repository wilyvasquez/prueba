...
<div class="wrapper">
  ...
  <div class="error-page">
    ...
    <div class="error-content">
      <h3><strong>Houston tenemos un problema.</strong></h3>
      <h4><i class="fa fa-warning text-yellow"></i> Mayday, Mayday ! Pagina no encontrada.</h4>

      <p>
        No pudimos encontrar la página que estabas buscando.
        Mientras tanto, puede regresar al tablero o intentar usar el formulario de búsqueda.
      </p>
...
<script src="<?= base_url() ?>bower_components/admin-lte/dist/js/demo.js"></script>
</body>
</html>
